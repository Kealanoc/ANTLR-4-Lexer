...
public interface calListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link calParser#empty_statement}.
	 * @param ctx the parse tree
	 */
	void enterEmpty_statement(calParser.Empty_statementContext ctx);
	/**
	 * Exit a parse tree produced by {@link calParser#empty_statement}.
	 * @param ctx the parse tree
	 */
	void exitEmpty_statement(calParser.Empty_statementContext ctx);
	/**
	 * Enter a parse tree produced by {@link calParser#empty_arg_list}.
	 * @param ctx the parse tree
	 */
	void enterEmpty_arg_list(calParser.Empty_arg_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link calParser#empty_arg_list}.
	 * @param ctx the parse tree
	 */
	void exitEmpty_arg_list(calParser.Empty_arg_listContext ctx);
}